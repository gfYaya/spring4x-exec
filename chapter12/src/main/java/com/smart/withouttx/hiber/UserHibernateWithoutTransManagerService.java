...
public class UserHibernateWithoutTransManagerService {
    ...
    public void addScore(String userName,int toAdd){
        //get是主键查询,以userName为主键进行查询,User类中将userName这个属性加入了@Id,即为hibernate主键的意思
    ...
    public void addScore(Integer id,int toAdd){
        //User user = hibernateTemplate.get(User.class,id);
        List lists = hibernateTemplate.find("from User where user_id=?",id);
