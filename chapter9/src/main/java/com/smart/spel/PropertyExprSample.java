...
public class PropertyExprSample {
    public static void main(String[] args) {
        ...
        int credits = (Integer) parser.parseExpression("credits + 10").getValue(context); //110
        ...
        //parser.parseExpression("booleanList[0]").setValue(simpleContext, "false1");        //b将被设置为false
