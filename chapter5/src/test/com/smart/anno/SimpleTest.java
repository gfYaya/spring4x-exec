...
public class SimpleTest {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        System.out.println(logonService.logDao == null);
        System.out.println(logonService.userDao == null);
        //assertNotNull(logonService.logDao);
        //assertNotNull(logonService.userDao);
